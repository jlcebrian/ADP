	xdef	DecompressOldRLEToPlanar8Asm
	...
	; Production old-RLE decompressor for Amiga.
	; This is the promoted experimental prototype path: it emits Planar8
	; (P0P1P2P3) data without using the large lookup tables required by the
	; old PlanarST/plane-major decoders. The caller performs the final format
	; conversion to native plane-major output.
