...
2. **128K graphics/database page mapping**: centralized logical-index →
   page/local resolution (currently only page-zero records are
   materialized); GOSUB page save/restore.
